...
const getImages = (query) => {
  ...
  fetch(url)
    ...
    .then(data => showImages(data.hits)) //Problem Solution
...
const createSlider = () => {
  ...
  let duration = document.getElementById('duration').value || 1000; //Problem Solution
...
sliderBtn.addEventListener('click', function () {
  ...
  if (duration < 0) {
    alert('Give a positive value')
  } else {
    createSlider();
  }
})

// Spnier For Data Load
const spinnerLoder = () => {
